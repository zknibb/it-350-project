...
INSERT INTO `Assignments` VALUES (10,1),(11,1),(11,2);
...
INSERT INTO `AttachedTo` VALUES (1,1),(2,1),(3,2);
...
INSERT INTO `Cruisers` VALUES (10000,'Crown Vic',1,22),(10003,'Charger',1,NULL);
...
INSERT INTO `Detectives` VALUES (10,'Bronson','Jet',1),(11,'Smith','Andy',1);
...
INSERT INTO `Divisions` VALUES ('Drug Enforcement',1),('SWAT',1),('Theft',1),('Traffic',1);
...
INSERT INTO `Evidence` VALUES (1,'Fingerprints',1),(2,'Blood splatter',1),(3,'Jazz flute',2);
...
INSERT INTO `Incidents` VALUES (1,'Bar Fight','McLaren\'s'),(2,'Breaking and entering','CTB'),(3,'Gunslingin\'','Nickelcade');
...
INSERT INTO `Officers` VALUES (22,'Jones','Robert','Officer','Traffic'),(26,'Johnson','Cliff','Corporal','Theft');
...
CREATE TABLE `Radios` (
  ...
  CONSTRAINT `Radios_ibfk_2` FOREIGN KEY (`officerId`) REFERENCES `Officers` (`officerId`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Radios` VALUES (1,1,26),(3,1,NULL);
...
INSERT INTO `Respond` VALUES (22,1),(26,1),(26,2);
...
CREATE TABLE `Sidearms` (
  ...
  CONSTRAINT `Sidearms_ibfk_2` FOREIGN KEY (`officerId`) REFERENCES `Officers` (`officerId`)
...
INSERT INTO `Sidearms` VALUES (1001,'Magnum',1,NULL),(1002,'45',1,22);
...
INSERT INTO `Suspect` VALUES (1,'Hamburglar','12345 McDonald Way',1),(2,'Biggie','Compton',1),(3,'Ron Burgundy','San Diego',2);
...
-- Dump completed on 2017-04-17 12:37:00
